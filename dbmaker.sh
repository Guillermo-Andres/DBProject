...
echo "create table person(person_id serial primary key, person_firstname varchar(15) not null, person_lastname varchar(15) not null, person_dob varchar(10) not null, person_city varchar(30) not null, person_phone_number varchar(15), person_email varchar(30));
      ...
      create table request(request_id serial primary key, resource_keyword varchar(20) not null, request_date date not null);
      ...
      create table babyFood(babyFood_id serial primary key, resource_id integer references resource(resource_id) not null, babyFood_type varchar(10), babyFood_is_perishable boolean, babyFood_ingredients varchar(50), babyFood_unitSize varchar(10),  babyFood_expDate varchar(10));
      create table dryFood(dryFood_id serial primary key, resource_id integer references resource(resource_id) not null, dryFood_type varchar(10), dryFood_is_perishable boolean, dryFood_ingredients varchar(50), dryFood_unitSize varchar(10),  dryFood_expDate varchar(10));
      create table cannedFood(cannedFood_id serial primary key, resource_id integer references resource(resource_id) not null, cannedFood_type varchar(10), cannedFood_is_perishable boolean, cannedFood_ingredients varchar(50), cannedFood_unitSize varchar(10), cannedFood_expDate varchar(10));
