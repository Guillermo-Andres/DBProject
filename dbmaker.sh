...
echo "create table person(person_id serial primary key, person_firstname varchar(15), person_lastname varchar(15), person_dob varchar(10), person_address varchar(30), person_phone_number varchar(15), person_email varchar(30));
      ...
      create table dryFood(dryFood_id serial primary key, resource_id integer references resource(resource_id), dryFood_type varchar(10), dryFood_is_perishable boolean, dryFood_ingrendients varchar(50), dryFood_unitSize varchar(10), dryFood_description varchar(20), dryFood_expDate varchar(10));
      create table cannedFood(cannedFood_id serial primary key, resource_id integer references resource(resource_id), cannedFood_type varchar(10), cannedFood_is_perishable boolean, cannedFood_ingrendients varchar(50), cannedFood_unitSize varchar(10), cannedFood_description varchar(20), cannedFood_expDate varchar(10));
      create table heavyEquipment(heavyEquipment_id serial primary key, resource_id integer references resource(resource_id), heavyEquipment_type varchar(10), heavyEquipment_description varchar(20));
      create table medicalDevices(medicalDevices_id serial primary key, resource_id integer references resource(resource_id), medicalDevices_type varchar(10), medicalDevices_description varchar(20));
